...
<section class="hero-section" style="background-color: #1e4bb1; color: white; padding: 100px 0; text-align: center;">
    <div class="container">
        <h1 style="font-size: 3.5rem; font-weight: bold;">Instrumen Akreditasi Program Studi (IAPS)</h1>
...
<section class="py-5">
    <div class="container bg-white shadow-sm p-4 p-md-5 rounded-3 border-start border-4 border-primary">
        <div class="text-center mb-4">
            <h2 class="fw-bold mb-2">Daftar <span class="text-primary">Dokumen IAPS</span></h2>
            ...
            <p class="text-muted mx-auto" style="max-width: 900px; line-height: 1.8;">
                Daftar instrumen akreditasi untuk Program Studi.
            </p>
        </div>
        <div class="table-responsive mt-4">
            <table id="tabelIap" class="table table-bordered table-hover align-middle w-100">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                @if (Session::has('logged_in'))
                                    <a href="{{ route('dokumen.download', $doc->no_dokumen) }}" class="btn btn-sm btn-success px-3 shadow-sm">
                                        <i class="fas fa-download me-1"></i> Unduh
                                    </a>
                                @else
                                    <button type="button" class="btn btn-sm btn-outline-primary shadow-sm px-3" data-bs-toggle="modal" data-bs-target="#loginModal">
