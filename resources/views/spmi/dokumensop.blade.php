...
@section('title', 'Dokumen SOP - SPMI STMI')
...
<section class="hero-section" style="background-color: #1e4bb1; color: white; padding: 100px 0; text-align: center;">
    <div class="container">
        <h1 style="font-size: 3.5rem; font-weight: bold;">Dokumen SOP</h1>
...
<section class="py-5">
    {{-- Card Container mirip Standar Mutu --}}
    <div class="container bg-white shadow-sm p-4 p-md-5 rounded-3 border-start border-4 border-info">
        <div class="text-center mb-5">
            <h2 class="fw-bold mb-3">Dokumen Standar Operasional Prosedur <span class="text-primary">(SOP)</span></h2>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                @if (Session::has('logged_in'))
                                    {{-- Menggunakan route download yang ada di web.php --}}
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="text-center py-4 text-muted">
                                <i class="fas fa-info-circle me-1"></i> Belum ada dokumen SOP yang divalidasi.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
